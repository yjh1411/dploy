  ...
  module.exports = Deploy = (function() {
    ...
    */
    ...
    Deploy.prototype.setupFallbackConfig = function() {
      var regExpPath, _base, _base1, _base10, _base2, _base3, _base4, _base5, _base6, _base7, _base8, _base9, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if ((_ref = this.server) == null) {
        this.server = this.config.host;
      }
      if ((_ref1 = (_base = this.config).scheme) == null) {
        _base.scheme = "ftp";
      }
      if ((_ref2 = (_base1 = this.config).port) == null) {
        _base1.port = (this.config.scheme === "ftp" ? 21 : 22);
      }
      if ((_ref3 = (_base2 = this.config).secure) == null) {
        _base2.secure = false;
      }
      if ((_ref4 = (_base3 = this.config).secureOptions) == null) {
        _base3.secureOptions = {};
      }
      if ((_ref5 = (_base4 = this.config).slots) == null) {
        _base4.slots = 1;
      }
      if ((_ref6 = (_base5 = this.config).revision) == null) {
        _base5.revision = ".rev";
      }
      if ((_ref7 = (_base6 = this.config).path) == null) {
        _base6.path = {};
      }
      if ((_ref8 = (_base7 = this.config.path).local) == null) {
        _base7.local = "";
      }
      if ((_ref9 = (_base8 = this.config.path).remote) == null) {
        _base8.remote = "";
      }
      if ((_ref10 = (_base9 = this.config).exclude) == null) {
        _base9.exclude = [];
      }
      if ((_ref11 = (_base10 = this.config).include) == null) {
        _base10.include = {};
      }
